...
generator.add(layers.Dense(6272, activation=None, input_shape=(100,),
...
def train_step(images):
    ...
    for w in discriminator.trainable_variables:
        w.assign(tf.clip_by_value(w, -0.005, 0.005))
...
def train(ds):
    ...
    for step in range(NUM_STEPS):
        ...
        if step % 5000 == 0:
            ...
            plt.savefig('new_samples2/{}.png'.format(str(it).zfill(3)), bbox_inches='tight')
            plt.close(fig)
            it += 1
